...
const overlappingHotel = new Hotel("4", "", date2, transitDay2, "", [
  overlappingRoom,
]);

const split1 = new TripSegment(
  "1",
  "",
  startdate,
  transitDay1,
...
const overlappingSplit = new TripSegment(
  "4",
  "",
  date2,
  transitDay2,
...
describe("entire trip", () => {
  ...
  test("split integration", () => {
    ...
    expect(testTrip.listDays()).toStrictEqual([
      day1,
      day2,
      day3,
      day4,
